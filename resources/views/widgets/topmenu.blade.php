        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <ul class="col-lg-3 all-right">
                    <li style="cursor:pointer;" id="button_spec_vision"><a class="img"><img src="{{ asset('img/icon-head1.png') }}"></a></li>
                    <li id="search-console"><a class="img" href="#"><img src="{{ asset('img/icon-head2.png') }}"></a></li>
                    <li><a class="active" href="/{{ $lang }}" style="text-transform: uppercase;">{{$lang }}</a></li>
                </ul>
            </div>
        </div>
    </div>
